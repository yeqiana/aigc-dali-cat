...
```text
=== PASS D:\workspace\YeQianWorkSpace\yeqian\storyOS\episodes\天界普通人的一天 ===
[PASS] clean
```
- ✅ machine_gate.py --target VISUAL_CALIBRATED

```text
=== PASS MACHINE GATE VISUAL_CALIBRATED :: D:\workspace\YeQianWorkSpace\yeqian\storyOS\episodes\天界普通人的一天 ===
[PASS] clean
```
