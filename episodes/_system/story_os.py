...
def main():
    ...
    p = sub.add_parser("visual-profile"); p.add_argument("episode_dir"); p.add_argument("profile_cmd", choices=["show", "set-default", "set-override", "list"]); p.add_argument("extra", nargs=argparse.REMAINDER)
    ...
    if args.cmd == "visual-profile":
        if args.profile_cmd == "list":
            return forward("visual_profile.py", [args.profile_cmd, *args.extra])
