...
- For multi-person travel/return-home/outing stories, ordinary_baseline should prefer Frame 01/02 vehicle selfie or destination check-in group selfie. Use it to lock primary faces, hairstyles, body-build range, initial wardrobe and relationship context; real-person style references must never become identity masters.
