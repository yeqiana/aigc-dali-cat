...
```text
=== PASS D:\workspace\YeQianWorkSpace\yeqian\aigc-dali-cat\episodes\10_彼此的天上\03_雾中的另一座生活区 ===
[PASS] clean
```
- ✅ machine_gate.py --target PUBLISH_READY

```text
=== PASS MACHINE GATE PUBLISH_READY :: D:\workspace\YeQianWorkSpace\yeqian\aigc-dali-cat\episodes\10_彼此的天上\03_雾中的另一座生活区 ===
[PASS] clean
```
