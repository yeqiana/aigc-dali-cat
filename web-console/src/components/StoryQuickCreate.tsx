...
const REAL_STORY_PROMPTS = [
  '明天就是婚礼，我却一夜梦见自己被人锁着；醒来后婚鞋还在，只是变成了铁环，手镯也变成了镣铐。记忆被药物与角色扮演替换。',
  '老旧柜顶上的一只透明玻璃瓶，收纳着三十年前一整个村庄失踪前的最后回响与微缩活景。',
  '鳌太穿越遇险记录，狂风暴雪中一间违背常理的护林员石屋，炉子上煮着滚烫的热汤。',
  '雨夜车窗上缓缓印出的指纹与呼救，副驾驶座上空无一人，倒车镜里却坐着全身湿透的女子。',
  '仲夏深夜突然拉闸停电，隔壁老屋传来刺耳的指甲刮擦墙皮声与蝉蜕般的嘶鸣。'
];
      ...
      <div className="bg-gradient-to-r from-zinc-900 via-neutral-900 to-zinc-950 rounded-xl p-5 border border-zinc-800 text-white shadow-md relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-3 pt-2.5 border-t border-zinc-800/80">
            ...
            {REAL_STORY_PROMPTS.map((sample, idx) => (
              <button
                key={idx}
