...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  // 1. 主题选择: 'dark' | 'light' | 'light-gradient'
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              >
                <div className={`w-full aspect-[16/10] rounded-xl overflow-hidden border transition-all p-2 flex flex-col justify-end bg-[#181a20] ${
                  ...
                  <div className="w-full h-4/5 bg-[#0B0D10] rounded-t-lg p-2 space-y-1.5 shadow-sm border border-[#232830]">
                    <div className="w-16 h-1.5 bg-blue-500/80 rounded-full" />
              ...
              >
                <div className={`w-full aspect-[16/10] rounded-xl overflow-hidden border transition-all p-2 flex flex-col justify-end bg-[#e4e4e7] ${
                  ...
                  <div className="w-full h-4/5 bg-white rounded-t-lg p-2 space-y-1.5 shadow-sm border border-zinc-200">
                    <div className="w-16 h-1.5 bg-amber-500/80 rounded-full" />
              ...
              <button
                type="button"
                onClick={() => {
                  setThemeMode('light-gradient');
                  showToast('已切换为「浅色渐变」主题模式');
                }}
                className={`group flex flex-col items-center gap-2 text-left cursor-pointer focus:outline-hidden ${
                  themeMode === 'light-gradient' ? 'text-white' : 'text-zinc-400 hover:text-zinc-200'
                }`}
              >
                <div className={`w-full aspect-[16/10] rounded-xl overflow-hidden border transition-all p-2 flex flex-col justify-end bg-gradient-to-br from-blue-100 via-purple-100 to-teal-100 ${
                  themeMode === 'light-gradient'
                    ? 'border-indigo-500 ring-2 ring-indigo-500/20'
                    : 'border-[#2e2e2e] hover:border-[#444]'
                }`}>
                  <div className="w-full h-4/5 bg-white/90 backdrop-blur-xs rounded-t-lg p-2 space-y-1.5 shadow-sm border border-indigo-100">
                    <div className="w-16 h-1.5 bg-indigo-500/80 rounded-full" />
                    <div className="w-full h-1 bg-indigo-200 rounded-full" />
                    <div className="w-5/6 h-1 bg-purple-200 rounded-full" />
                  </div>
                </div>
                <div className="flex items-center gap-1.5 text-xs font-medium">
