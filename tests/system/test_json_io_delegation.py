...
WHITELIST = {
    ...
    ("production_ledger.py", "load_json"): "SystemExit loud-evidence contract",
    ("production_ledger.py", "save_json"): "already delegates to atomic_write_json (same atomic path)",
